...
// Recipients
$fromEmail = 'contactus@trisentrix.com'; // Email address that will be in the from field of the message.
$fromName = 'From Name'; // Name that will be in the from field of the message.
$sendToEmail = 'contactus@trisentrix.com'; // Email address that will receive the message with the output of the form
$sendToName = 'To Name'; // Name that will receive the message with the output of the form

// Subject
$subject = 'Message from TriSenTrix contact form';
